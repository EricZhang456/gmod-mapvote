...
local reloadConfigCmd = ulx.command(CATEGORY_NAME, "ulx reloadmapvoteconfig", function (calling_ply, votetime, should_cancel)
	MapVote.ReladConfig()
end, "!reloadmapvoteconfig")
reloadConfigCmd:defaultAccess(ULib.ACCESS_ADMIN)
reloadConfigCmd:help("Reloads the map vote config")
